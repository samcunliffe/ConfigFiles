...
"""
ConfigFiles/install.py

Makes a symbolic link in the home dir for all config files with pattern:
"dot.file" or "dot.dir" in the repo. This setup structcture was stolen from
github.com/rumblesan.  Optionally installs gnome-terminal colour scheme.
"""
...
def make_config_link(path_to_configfile, configfile, homedir):
    ...
    return symbolic_link(
        path_to_configfile + configfile, homedir + configfile.replace(pattern, ".")
    )
